...
where $R[g]$ is the Ricci scalar. There's no preferred choice of $\alpha$ and different ways to regularise the path integral $\Rightarrow$ different values of $\alpha$. 
