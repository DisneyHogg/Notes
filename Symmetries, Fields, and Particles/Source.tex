...
\[
\forall v_\Lambda\in V_\Lambda, \, \forall \alpha\in\Phi_+ R(E^\alpha)v-\Lambda=0
\]
If the representation is irreducible, all other weight are generate as product of $R(E^{-\alpha})$ for $\alpha\in\Phi_+$. 
\end{definition}
